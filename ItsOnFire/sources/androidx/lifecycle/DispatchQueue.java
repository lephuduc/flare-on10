...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(@NotNull final CoroutineContext context, @NotNull final Runnable runnable) {
        ...
        z2 q2 = m1.e().q();
        if (q2.isDispatchNeeded(context) || canRun()) {
            q2.dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$dispatchAndEnqueue$$inlined$with$lambda$1
