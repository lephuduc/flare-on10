...
public final class Rgb$oetf$1 extends Lambda implements Function1<Double, Double> {
    ...
    public final Double invoke(double d2) {
        ...
        float f3;
        double coerceIn;
        double doubleValue = this.this$0.getOetfOrig$ui_graphics_release().invoke(Double.valueOf(d2)).doubleValue();
        f2 = this.this$0.min;
        f3 = this.this$0.max;
        coerceIn = RangesKt___RangesKt.coerceIn(doubleValue, f2, f3);
