...
public final class PaintingStyle {
    ...
    private static final int Fill = m1590constructorimpl(0);
    private static final int Stroke = m1590constructorimpl(1);
    ...
    public static final class Companion {
        ...
        public final int m1596getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m1597getStrokeTiuSbCo() {
    ...
    public static final /* synthetic */ PaintingStyle m1589boximpl(int i2) {
        return new PaintingStyle(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1590constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1591equalsimpl(int i2, Object obj) {
        return (obj instanceof PaintingStyle) && i2 == ((PaintingStyle) obj).m1595unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1592equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1593hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1594toStringimpl(int i2) {
        return m1592equalsimpl0(i2, Fill) ? "Fill" : m1592equalsimpl0(i2, Stroke) ? "Stroke" : "Unknown";
    }

    public boolean equals(Object obj) {
        return m1591equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1593hashCodeimpl(this.value);
    }

    @NotNull
    public String toString() {
        return m1594toStringimpl(this.value);
    }
