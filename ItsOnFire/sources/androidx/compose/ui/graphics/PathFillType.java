...
public final class PathFillType {
    ...
    private static final int NonZero = m1602constructorimpl(0);
    private static final int EvenOdd = m1602constructorimpl(1);
    ...
    public static final class Companion {
        ...
        public final int m1608getEvenOddRgk1Os() {
            return PathFillType.EvenOdd;
        }

        /* renamed from: getNonZero-Rg-k1Os  reason: not valid java name */
        public final int m1609getNonZeroRgk1Os() {
    ...
    public static final /* synthetic */ PathFillType m1601boximpl(int i2) {
        return new PathFillType(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1602constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1603equalsimpl(int i2, Object obj) {
        return (obj instanceof PathFillType) && i2 == ((PathFillType) obj).m1607unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1604equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1605hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1606toStringimpl(int i2) {
        return m1604equalsimpl0(i2, NonZero) ? "NonZero" : m1604equalsimpl0(i2, EvenOdd) ? "EvenOdd" : "Unknown";
    }
