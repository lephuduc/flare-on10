...
public final class LiveRegionMode {
    ...
    private static final int Polite = m2967constructorimpl(0);
    private static final int Assertive = m2967constructorimpl(1);
    ...
    public static final /* synthetic */ LiveRegionMode m2966boximpl(int i2) {
        return new LiveRegionMode(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2967constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2968equalsimpl(int i2, Object obj) {
        return (obj instanceof LiveRegionMode) && i2 == ((LiveRegionMode) obj).m2972unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2969equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2970hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2971toStringimpl(int i2) {
        return m2969equalsimpl0(i2, Polite) ? "Polite" : m2969equalsimpl0(i2, Assertive) ? "Assertive" : "Unknown";
    }
