...
public final class KeyEventType {
    ...
    private static final int Unknown = m2538constructorimpl(0);
    private static final int KeyUp = m2538constructorimpl(1);
    private static final int KeyDown = m2538constructorimpl(2);
    ...
    public static final /* synthetic */ KeyEventType m2537boximpl(int i2) {
        return new KeyEventType(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2538constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2539equalsimpl(int i2, Object obj) {
        return (obj instanceof KeyEventType) && i2 == ((KeyEventType) obj).m2543unboximpl();
    }
    ...
    public static String m2542toStringimpl(int i2) {
        return m2540equalsimpl0(i2, KeyUp) ? "KeyUp" : m2540equalsimpl0(i2, KeyDown) ? "KeyDown" : m2540equalsimpl0(i2, Unknown) ? "Unknown" : "Invalid";
    }
