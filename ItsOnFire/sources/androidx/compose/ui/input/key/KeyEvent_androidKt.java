...
public final class KeyEvent_androidKt {
    ...
    public static final long m2547getKeyZmokQxo(@NotNull android.view.KeyEvent key) {
        Intrinsics.checkNotNullParameter(key, "$this$key");
        return Key_androidKt.Key(key.getKeyCode());
    }

    /* renamed from: getType-ZmokQxo  reason: not valid java name */
    public static final int m2548getTypeZmokQxo(@NotNull android.view.KeyEvent type) {
        Intrinsics.checkNotNullParameter(type, "$this$type");
        int action = type.getAction();
        return action != 0 ? action != 1 ? KeyEventType.Companion.m2546getUnknownCS__XNY() : KeyEventType.Companion.m2545getKeyUpCS__XNY() : KeyEventType.Companion.m2544getKeyDownCS__XNY();
    }

    /* renamed from: getUtf16CodePoint-ZmokQxo  reason: not valid java name */
    public static final int m2549getUtf16CodePointZmokQxo(@NotNull android.view.KeyEvent utf16CodePoint) {
    ...
    public static final boolean m2550isAltPressedZmokQxo(@NotNull android.view.KeyEvent isAltPressed) {
        Intrinsics.checkNotNullParameter(isAltPressed, "$this$isAltPressed");
        return isAltPressed.isAltPressed();
    }

    /* renamed from: isCtrlPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m2551isCtrlPressedZmokQxo(@NotNull android.view.KeyEvent isCtrlPressed) {
    ...
    public static final boolean m2552isMetaPressedZmokQxo(@NotNull android.view.KeyEvent isMetaPressed) {
        Intrinsics.checkNotNullParameter(isMetaPressed, "$this$isMetaPressed");
        return isMetaPressed.isMetaPressed();
    }

    /* renamed from: isShiftPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m2553isShiftPressedZmokQxo(@NotNull android.view.KeyEvent isShiftPressed) {
