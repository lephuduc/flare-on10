...
public final class SuspendingPointerInputFilterKt$pointerInput$4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i2) {
        ...
        EffectsKt.LaunchedEffect(composed, this.$key1, this.$key2, new SuspendingPointerInputFilterKt$pointerInput$4$2$1(suspendingPointerInputFilter, this.$block, null), composer, (i2 & 14) | 576);
        composer.endReplaceableGroup();
