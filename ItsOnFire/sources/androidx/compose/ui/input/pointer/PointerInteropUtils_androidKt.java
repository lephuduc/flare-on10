...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m2703toCancelMotionEventScoped4ec7I(@NotNull PointerEvent toCancelMotionEventScope, long j2, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m2705toMotionEventScopeubNVwUQ(toCancelMotionEventScope, j2, block, true);
    }

    /* renamed from: toMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m2704toMotionEventScoped4ec7I(@NotNull PointerEvent toMotionEventScope, long j2, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m2705toMotionEventScopeubNVwUQ(toMotionEventScope, j2, block, false);
    }

    /* renamed from: toMotionEventScope-ubNVwUQ  reason: not valid java name */
    private static final void m2705toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j2, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        motionEvent$ui_release.offsetLocation(-Offset.m1161getXimpl(j2), -Offset.m1162getYimpl(j2));
