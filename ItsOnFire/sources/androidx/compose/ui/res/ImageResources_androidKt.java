...
public final class ImageResources_androidKt {
    @Composable
    @NotNull
    public static final ImageBitmap imageResource(@NotNull ImageBitmap.Companion companion, @DrawableRes int i2, @Nullable Composer composer, int i3) {
        ...
        if (changed || rememberedValue2 == companion2.getEmpty()) {
            ...
            rememberedValue2 = imageResource(companion, resources, i2);
