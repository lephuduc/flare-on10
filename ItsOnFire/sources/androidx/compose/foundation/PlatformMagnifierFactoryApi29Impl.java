...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo207updateWko1d7g(long j2, long j3, float f2) {
            ...
            boolean m1180isSpecifiedk4lQ0M = OffsetKt.m1180isSpecifiedk4lQ0M(j3);
            Magnifier magnifier = getMagnifier();
            if (m1180isSpecifiedk4lQ0M) {
                magnifier.show(Offset.m1161getXimpl(j2), Offset.m1162getYimpl(j2), Offset.m1161getXimpl(j3), Offset.m1162getYimpl(j3));
            } else {
                magnifier.show(Offset.m1161getXimpl(j2), Offset.m1162getYimpl(j2));
            }
        }
    }
    ...
    public PlatformMagnifierImpl create(@NotNull MagnifierStyle style, @NotNull View view, @NotNull Density density, float f2) {
        ...
        long mo278toSizeXkaWNTQ = density.mo278toSizeXkaWNTQ(style.m206getSizeMYxV2XQ$foundation_release());
        float mo277toPx0680j_4 = density.mo277toPx0680j_4(style.m204getCornerRadiusD9Ej5fM$foundation_release());
        float mo277toPx0680j_42 = density.mo277toPx0680j_4(style.m205getElevationD9Ej5fM$foundation_release());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo278toSizeXkaWNTQ != Size.Companion.m1238getUnspecifiedNHjbRc()) {
            roundToInt = MathKt__MathJVMKt.roundToInt(Size.m1230getWidthimpl(mo278toSizeXkaWNTQ));
            roundToInt2 = MathKt__MathJVMKt.roundToInt(Size.m1227getHeightimpl(mo278toSizeXkaWNTQ));
            builder.setSize(roundToInt, roundToInt2);
        }
        if (!Float.isNaN(mo277toPx0680j_4)) {
            builder.setCornerRadius(mo277toPx0680j_4);
        }
        if (!Float.isNaN(mo277toPx0680j_42)) {
            builder.setElevation(mo277toPx0680j_42);
        }
        if (!Float.isNaN(f2)) {
