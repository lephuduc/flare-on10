...
public final class ClickableTextKt$ClickableText$pressIndicator$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function1<Offset, Unit> {
        ...
        public AnonymousClass1(MutableState<TextLayoutResult> mutableState, Function1<? super Integer, Unit> function1) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m527invokek4lQ0M(offset.m1171unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
        public final void m527invokek4lQ0M(long j2) {
            TextLayoutResult value = this.$layoutResult.getValue();
            if (value == null) {
                return;
            }
            this.$onClick.invoke(Integer.valueOf(value.m3058getOffsetForPositionk4lQ0M(j2)));
        }
    }
