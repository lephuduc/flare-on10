...
public final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    @NotNull
    public final VerticalScrollLayoutModifier copy(@NotNull TextFieldScrollerPosition scrollerPosition, int i2, @NotNull TransformedText transformedText, @NotNull Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        Intrinsics.checkNotNullParameter(scrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText, "transformedText");
        Intrinsics.checkNotNullParameter(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public MeasureResult mo21measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        Placeable mo2758measureBRTryo0 = measurable.mo2758measureBRTryo0(Constraints.m3284copyZbe2FdA$default(j2, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        int min = Math.min(mo2758measureBRTryo0.getHeight(), Constraints.m3292getMaxHeightimpl(j2));
        return MeasureScope.DefaultImpls.layout$default(receiver, mo2758measureBRTryo0.getWidth(), min, null, new VerticalScrollLayoutModifier$measure$1(receiver, this, mo2758measureBRTryo0, min), 4, null);
    }
