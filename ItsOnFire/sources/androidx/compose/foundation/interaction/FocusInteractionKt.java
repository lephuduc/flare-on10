...
public final class FocusInteractionKt {
    @Composable
    @NotNull
    public static final State<Boolean> collectIsFocusedAsState(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        EffectsKt.LaunchedEffect(interactionSource, new FocusInteractionKt$collectIsFocusedAsState$1(interactionSource, mutableState, null), composer, i2 & 14);
        composer.endReplaceableGroup();
        return mutableState;
    }
}
