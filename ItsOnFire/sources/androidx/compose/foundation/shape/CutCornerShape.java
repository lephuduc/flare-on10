...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo500createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1230getWidthimpl(j2) - f2, 0.0f);
        Path.lineTo(Size.m1230getWidthimpl(j2), f2);
        float f7 = layoutDirection == layoutDirection2 ? f4 : f5;
        Path.lineTo(Size.m1230getWidthimpl(j2), Size.m1227getHeightimpl(j2) - f7);
        Path.lineTo(Size.m1230getWidthimpl(j2) - f7, Size.m1227getHeightimpl(j2));
        if (layoutDirection == layoutDirection2) {
            f4 = f5;
        }
        Path.lineTo(f4, Size.m1227getHeightimpl(j2));
        Path.lineTo(0.0f, Size.m1227getHeightimpl(j2) - f4);
        Path.close();
