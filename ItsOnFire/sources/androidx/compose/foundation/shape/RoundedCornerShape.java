...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo500createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, @NotNull LayoutDirection layoutDirection) {
        ...
        Rect m1251toRectuvyYCjk = SizeKt.m1251toRectuvyYCjk(j2);
        LayoutDirection layoutDirection2 = LayoutDirection.Ltr;
        return new Outline.Rounded(RoundRectKt.m1213RoundRectZAM2FJo(m1251toRectuvyYCjk, CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f2 : f3, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f3 : f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f4 : f5, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f5 : f4, 0.0f, 2, null)));
    }
