...
public final class LazyListScopeImpl$item$2 extends Lambda implements Function2<LazyItemScope, Integer, Function2<? super Composer, ? super Integer, ? extends Unit>> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyListScopeImpl$item$2(Function3<? super LazyItemScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
        this.$content = function3;
    }
