...
public final class LazyGridKt$itemsIndexed$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull LazyItemScope items, int i2, @Nullable Composer composer, int i3) {
        ...
        if (((i4 & 731) ^ 146) == 0 && composer.getSkipping()) {
            ...
            this.$itemContent.invoke(items, Integer.valueOf(i2), this.$items[i2], composer, Integer.valueOf((i4 & 14) | (i4 & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)));
        }
    }
}
