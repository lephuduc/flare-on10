...
public final class PaddingKt$paddingqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public PaddingKt$paddingqDBjuR0$$inlined$debugInspectorInfo$1(float f2, float f3, float f4, float f5) {
        super(1);
        this.$start$inlined = f2;
        this.$top$inlined = f3;
        this.$end$inlined = f4;
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("start", Dp.m3323boximpl(this.$start$inlined));
        inspectorInfo.getProperties().set("top", Dp.m3323boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set("end", Dp.m3323boximpl(this.$end$inlined));
