...
public final class PaddingKt$paddingVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public PaddingKt$paddingVpY3zN4$$inlined$debugInspectorInfo$1(float f2, float f3) {
        super(1);
        this.$horizontal$inlined = f2;
        this.$vertical$inlined = f3;
    }
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("horizontal", Dp.m3323boximpl(this.$horizontal$inlined));
        inspectorInfo.getProperties().set("vertical", Dp.m3323boximpl(this.$vertical$inlined));
    }
}
