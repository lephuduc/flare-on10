...
public final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetTextUnit(AlignmentLine alignmentLine, long j2, long j3, Function1<? super InspectorInfo, Unit> function1) {
        super(function1);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m3503equalsimpl0(m315getBeforeXSAIIZE(), alignmentLineOffsetTextUnit.m315getBeforeXSAIIZE()) && TextUnit.m3503equalsimpl0(m314getAfterXSAIIZE(), alignmentLineOffsetTextUnit.m314getAfterXSAIIZE());
    }
    ...
    public final long m314getAfterXSAIIZE() {
        return this.after;
    }
    ...
    public final long m315getBeforeXSAIIZE() {
        return this.before;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m3507hashCodeimpl(m315getBeforeXSAIIZE())) * 31) + TextUnit.m3507hashCodeimpl(m314getAfterXSAIIZE());
    }
    ...
    public MeasureResult mo21measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        MeasureResult m303alignmentLineOffsetMeasuretjqqzMA;
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        m303alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m303alignmentLineOffsetMeasuretjqqzMA(receiver, this.alignmentLine, !TextUnitKt.m3524isUnspecifiedR2X_6o(m315getBeforeXSAIIZE()) ? receiver.mo272toDpGaN1DYA(m315getBeforeXSAIIZE()) : Dp.Companion.m3345getUnspecifiedD9Ej5fM(), !TextUnitKt.m3524isUnspecifiedR2X_6o(m314getAfterXSAIIZE()) ? receiver.mo272toDpGaN1DYA(m314getAfterXSAIIZE()) : Dp.Companion.m3345getUnspecifiedD9Ej5fM(), measurable, j2);
        return m303alignmentLineOffsetMeasuretjqqzMA;
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m3513toStringimpl(m315getBeforeXSAIIZE())) + ", after=" + ((Object) TextUnit.m3513toStringimpl(m314getAfterXSAIIZE())) + ')';
    }
}
