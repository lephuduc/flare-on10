...
public final class PaddingValuesModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo21measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        boolean z = false;
        float f2 = 0;
        if (Dp.m3324compareTo0680j_4(this.paddingValues.mo374calculateLeftPaddingu2uoSUM(receiver.getLayoutDirection()), Dp.m3325constructorimpl(f2)) >= 0 && Dp.m3324compareTo0680j_4(this.paddingValues.mo376calculateTopPaddingD9Ej5fM(), Dp.m3325constructorimpl(f2)) >= 0 && Dp.m3324compareTo0680j_4(this.paddingValues.mo375calculateRightPaddingu2uoSUM(receiver.getLayoutDirection()), Dp.m3325constructorimpl(f2)) >= 0 && Dp.m3324compareTo0680j_4(this.paddingValues.mo373calculateBottomPaddingD9Ej5fM(), Dp.m3325constructorimpl(f2)) >= 0) {
            z = true;
        }
        if (z) {
            int mo271roundToPx0680j_4 = receiver.mo271roundToPx0680j_4(this.paddingValues.mo374calculateLeftPaddingu2uoSUM(receiver.getLayoutDirection())) + receiver.mo271roundToPx0680j_4(this.paddingValues.mo375calculateRightPaddingu2uoSUM(receiver.getLayoutDirection()));
            int mo271roundToPx0680j_42 = receiver.mo271roundToPx0680j_4(this.paddingValues.mo376calculateTopPaddingD9Ej5fM()) + receiver.mo271roundToPx0680j_4(this.paddingValues.mo373calculateBottomPaddingD9Ej5fM());
