...
public final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine, float f2, float f3, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.before = f2;
        this.after = f3;
        if (!((m313getBeforeD9Ej5fM() >= 0.0f || Dp.m3330equalsimpl0(m313getBeforeD9Ej5fM(), Dp.Companion.m3345getUnspecifiedD9Ej5fM())) && (m312getAfterD9Ej5fM() >= 0.0f || Dp.m3330equalsimpl0(m312getAfterD9Ej5fM(), Dp.Companion.m3345getUnspecifiedD9Ej5fM())))) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDp.alignmentLine) && Dp.m3330equalsimpl0(m313getBeforeD9Ej5fM(), alignmentLineOffsetDp.m313getBeforeD9Ej5fM()) && Dp.m3330equalsimpl0(m312getAfterD9Ej5fM(), alignmentLineOffsetDp.m312getAfterD9Ej5fM());
    }
    ...
    public final float m312getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    public final float m313getBeforeD9Ej5fM() {
        return this.before;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m3331hashCodeimpl(m313getBeforeD9Ej5fM())) * 31) + Dp.m3331hashCodeimpl(m312getAfterD9Ej5fM());
    }
    ...
    public MeasureResult mo21measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        m303alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m303alignmentLineOffsetMeasuretjqqzMA(receiver, this.alignmentLine, m313getBeforeD9Ej5fM(), m312getAfterD9Ej5fM(), measurable, j2);
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) Dp.m3336toStringimpl(m313getBeforeD9Ej5fM())) + ", after=" + ((Object) Dp.m3336toStringimpl(m312getAfterD9Ej5fM())) + ')';
    }
}
