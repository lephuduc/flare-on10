...
final class MaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo348calculateContentConstraintsl58MMJ0(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return Constraints.Companion.m3302fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m3293getMaxWidthimpl(j2)));
    }
    ...
    public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int i2) {
        return IntrinsicSizeModifier.DefaultImpls.maxIntrinsicWidth(this, intrinsicMeasureScope, intrinsicMeasurable, i2);
    }
