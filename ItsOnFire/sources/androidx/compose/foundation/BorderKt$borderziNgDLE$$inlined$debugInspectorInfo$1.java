...
public final class BorderKt$borderziNgDLE$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m3323boximpl(this.$width$inlined));
        if (this.$brush$inlined instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m1382boximpl(((SolidColor) this.$brush$inlined).m1651getValue0d7_KjU()));
            inspectorInfo.setValue(Color.m1382boximpl(((SolidColor) this.$brush$inlined).m1651getValue0d7_KjU()));
        } else {
