...
public final class TransformableStateKt$rotateBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public TransformableStateKt$rotateBy$2(float f2, Continuation<? super TransformableStateKt$rotateBy$2> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            ((TransformScope) this.L$0).mo222transformByd4ec7I(1.0f, Offset.Companion.m1177getZeroF1C5BW0(), this.$degrees);
