...
public final class SwitchKt$SwitchImpl$1$1 extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(@NotNull u0 u0Var, @Nullable Continuation<? super Unit> continuation) {
        return ((SwitchKt$SwitchImpl$1$1) create(u0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            j<Interaction> jVar = new j<Interaction>() { // from class: androidx.compose.material.SwitchKt$SwitchImpl$1$1$invokeSuspend$$inlined$collect$1
                @Override // o.j
                @Nullable
