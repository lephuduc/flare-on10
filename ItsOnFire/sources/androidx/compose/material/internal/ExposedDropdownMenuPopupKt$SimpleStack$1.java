    ...
    public final MeasureResult mo6measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j2) {
        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                return MeasureScope.DefaultImpls.layout$default(Layout, i4, i5, null, new ExposedDropdownMenuPopupKt$SimpleStack$1$measure$3(arrayList), 4, null);
            }
            ...
            map = null;
            function1 = new ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2(mo2758measureBRTryo0);
        } else {
            i2 = 0;
            i3 = 0;
            map = null;
            function1 = ExposedDropdownMenuPopupKt$SimpleStack$1$measure$1.INSTANCE;
        }
