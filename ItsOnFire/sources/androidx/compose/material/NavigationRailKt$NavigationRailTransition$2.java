...
public final class NavigationRailKt$NavigationRailTransition$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public NavigationRailKt$NavigationRailTransition$2(long j2, long j3, boolean z, Function3<? super Float, ? super Composer, ? super Integer, Unit> function3, int i2) {
        super(2);
        this.$activeColor = j2;
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        NavigationRailKt.m890NavigationRailTransitionKlgxPg(this.$activeColor, this.$inactiveColor, this.$selected, this.$content, composer, this.$$changed | 1);
    }
}
