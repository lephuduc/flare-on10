...
public final class OutlinedTextFieldKt$OutlinedTextField$2$1 extends Lambda implements Function1<TextFieldValue, Unit> {
    ...
    public OutlinedTextFieldKt$OutlinedTextField$2$1(String str, Function1<? super String, Unit> function1, MutableState<TextFieldValue> mutableState) {
        super(1);
        this.$value = str;
