...
public final class DrawerKt$Scrim$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public DrawerKt$Scrim$2(boolean z, Function0<Unit> function0, Function0<Float> function02, long j2, int i2) {
        super(2);
        this.$open = z;
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        DrawerKt.m817ScrimBx497Mc(this.$open, this.$onClose, this.$fraction, this.$color, composer, this.$$changed | 1);
    }
}
