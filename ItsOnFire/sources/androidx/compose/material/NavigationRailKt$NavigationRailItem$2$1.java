...
public final class NavigationRailKt$NavigationRailItem$2$1 extends Lambda implements Function3<Float, Composer, Integer, Unit> {
    ...
    public NavigationRailKt$NavigationRailItem$2$1(boolean z, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, int i2) {
        super(3);
    ...
    public final void invoke(float f2, @Nullable Composer composer, int i2) {
        ...
        NavigationRailKt.NavigationRailItemBaselineLayout(this.$icon, this.$styledLabel, f2, composer, (this.$$dirty >> 6) & 14);
    }
}
