...
public final class TabKt$Tab$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TabKt$Tab$5(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Function0<Unit> function0, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i2) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        ...
        Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m483selectableO2vRcR0(this.$modifier, this.$selected, this.$interactionSource, this.$ripple, this.$enabled, Role.m2975boximpl(Role.Companion.m2987getTabo7Vup1c()), this.$onClick), 0.0f, 1, null);
        Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
        Arrangement.HorizontalOrVertical center = Arrangement.INSTANCE.getCenter();
        Function3<ColumnScope, Composer, Integer, Unit> function3 = this.$content;
        int i3 = ((this.$$dirty >> 12) & 7168) | 432;
        composer.startReplaceableGroup(-1113030915);
        int i4 = i3 >> 3;
        MeasurePolicy columnMeasurePolicy = ColumnKt.columnMeasurePolicy(center, centerHorizontally, composer, (i4 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i4 & 14));
