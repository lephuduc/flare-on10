...
public final class TextKt$Text$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TextKt$Text$2(String str, Modifier modifier, long j2, long j3, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long j4, TextDecoration textDecoration, TextAlign textAlign, long j5, int i2, boolean z, int i3, Function1<? super TextLayoutResult, Unit> function1, TextStyle textStyle, int i4, int i5, int i6) {
        super(2);
        this.$text = str;
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        TextKt.m1027TextfLXpl1I(this.$text, this.$modifier, this.$color, this.$fontSize, this.$fontStyle, this.$fontWeight, this.$fontFamily, this.$letterSpacing, this.$textDecoration, this.$textAlign, this.$lineHeight, this.$overflow, this.$softWrap, this.$maxLines, this.$onTextLayout, this.$style, composer, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
