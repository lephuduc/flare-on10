...
public final class BottomNavigationKt$BottomNavigationItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public BottomNavigationKt$BottomNavigationItem$styledLabel$1$1(Function2<? super Composer, ? super Integer, Unit> function2, int i2) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        ...
        TextKt.ProvideTextStyle(m3084copyHL5avdY, this.$label, composer, (this.$$dirty >> 15) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
    }
}
