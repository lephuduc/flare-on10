...
public final class EnterExitTransitionKt$expandHorizontally$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m3477boximpl(m57invokemzRDjE0(intSize.m3489unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m57invokemzRDjE0(long j2) {
        return IntSizeKt.IntSize(this.$initialWidth.invoke(Integer.valueOf(IntSize.m3485getWidthimpl(j2))).intValue(), IntSize.m3484getHeightimpl(j2));
    }
}
