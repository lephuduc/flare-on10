...
public final class EnterExitTransitionKt$shrinkVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m3477boximpl(m64invokemzRDjE0(intSize.m3489unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m64invokemzRDjE0(long j2) {
        return IntSizeKt.IntSize(IntSize.m3485getWidthimpl(j2), this.$targetHeight.invoke(Integer.valueOf(IntSize.m3484getHeightimpl(j2))).intValue());
    }
}
