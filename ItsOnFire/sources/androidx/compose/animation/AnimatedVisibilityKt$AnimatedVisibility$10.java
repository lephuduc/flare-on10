...
public final class AnimatedVisibilityKt$AnimatedVisibility$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public AnimatedVisibilityKt$AnimatedVisibility$10(RowScope rowScope, MutableTransitionState<Boolean> mutableTransitionState, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, String str, Function3<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, Unit> function3, int i2, int i3) {
        super(2);
