...
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public PersistentSet<E> add(E e2) {
        ...
        if (isEmpty()) {
            return new PersistentOrderedSet(e2, e2, this.hashMap.put((PersistentHashMap<E, Links>) e2, (E) new Links()));
        }
        Object obj = this.lastElement;
        Links links = this.hashMap.get(obj);
        Intrinsics.checkNotNull(links);
        return new PersistentOrderedSet(this.firstElement, e2, ((PersistentHashMap<E, Links>) this.hashMap).put((ImmutableMap) obj, (Object) links.withNext(e2)).put((PersistentHashMap) e2, (E) new Links(obj)));
    }
    ...
    public PersistentSet<E> remove(E e2) {
        ...
        PersistentHashMap<E, Links> remove = this.hashMap.remove((PersistentHashMap<E, Links>) e2);
