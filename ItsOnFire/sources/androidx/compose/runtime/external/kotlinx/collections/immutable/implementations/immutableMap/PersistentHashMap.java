...
public final class PersistentHashMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0001\n\u0002\b\u0005\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u0002H\u0007\u0012\u0004\u0012\u0002H\b0\u0004\"\u0004\b\u0002\u0010\u0007\"\u0004\b\u0003\u0010\bH\u0000¢\u0006\u0002\b\tR\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableMap/PersistentHashMap$Companion;", "", "()V", "EMPTY", "Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableMap/PersistentHashMap;", "", "emptyOf", "K", "V", "emptyOf$runtime_release", "runtime_release"}, k = 1, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: classes.dex */
    ...
    public PersistentHashMap<K, V> put(K k2, V v2) {
        TrieNode.ModificationResult<K, V> put = this.node.put(k2 == null ? 0 : k2.hashCode(), k2, v2, 0);
    ...
    public PersistentHashMap<K, V> remove(K k2) {
        TrieNode<K, V> remove = this.node.remove(k2 == null ? 0 : k2.hashCode(), k2, 0);
    ...
    public PersistentHashMap<K, V> remove(K k2, V v2) {
        TrieNode<K, V> remove = this.node.remove(k2 == null ? 0 : k2.hashCode(), k2, v2, 0);
        return this.node == remove ? this : remove == null ? Companion.emptyOf$runtime_release() : new PersistentHashMap<>(remove, size() - 1);
    }
