...
public final class zzef {
    ...
    public zzef(Context context, String str, String str2, String str3, Bundle bundle) {
        this.zzd = (str == null || !zzW(str2, str3)) ? "FA" : "FA";
    ...
    private final void zzU(String str, String str2, Bundle bundle, boolean z, boolean z2, Long l2) {
        zzV(new zzds(this, l2, str, str2, bundle, z, z2));
    }
    ...
    public final void zzC(com.google.android.gms.measurement.internal.zzhg zzhgVar) {
        ...
        synchronized (this.zzf) {
            for (int i2 = 0; i2 < this.zzf.size(); i2++) {
                if (zzhgVar.equals(((Pair) this.zzf.get(i2)).first)) {
        ...
        synchronized (this.zzf) {
            ...
            while (true) {
                if (i2 >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzhgVar.equals(((Pair) this.zzf.get(i2)).first)) {
