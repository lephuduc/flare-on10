...
class UCollectionsKt___UCollectionsKt {
    ...
    public static final int sumOfUByte(@NotNull Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i2 = UInt.m3675constructorimpl(i2 + UInt.m3675constructorimpl(uByte.m3648unboximpl() & UByte.MAX_VALUE));
        }
        return i2;
    }
    ...
    public static final int sumOfUInt(@NotNull Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i2 = UInt.m3675constructorimpl(i2 + uInt.m3726unboximpl());
        }
        return i2;
    }
    ...
    public static final long sumOfULong(@NotNull Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j2 = ULong.m3753constructorimpl(j2 + uLong.m3804unboximpl());
        }
        return j2;
    }
    ...
    public static final int sumOfUShort(@NotNull Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i2 = UInt.m3675constructorimpl(i2 + UInt.m3675constructorimpl(uShort.m3908unboximpl() & UShort.MAX_VALUE));
        }
        return i2;
    }
    ...
    public static final byte[] toUByteArray(@NotNull Collection<UByte> collection) {
        ...
        byte[] m3650constructorimpl = UByteArray.m3650constructorimpl(collection.size());
        int i2 = 0;
        for (UByte uByte : collection) {
            UByteArray.m3661setVurrAj0(m3650constructorimpl, i2, uByte.m3648unboximpl());
            i2++;
        }
        return m3650constructorimpl;
    }
    ...
    public static final int[] toUIntArray(@NotNull Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] m3728constructorimpl = UIntArray.m3728constructorimpl(collection.size());
        int i2 = 0;
        for (UInt uInt : collection) {
            UIntArray.m3739setVXSXFK8(m3728constructorimpl, i2, uInt.m3726unboximpl());
            i2++;
        }
        return m3728constructorimpl;
    }
    ...
    public static final long[] toULongArray(@NotNull Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] m3806constructorimpl = ULongArray.m3806constructorimpl(collection.size());
        int i2 = 0;
        for (ULong uLong : collection) {
            ULongArray.m3817setk8EXiF4(m3806constructorimpl, i2, uLong.m3804unboximpl());
            i2++;
        }
        return m3806constructorimpl;
    }
    ...
    public static final short[] toUShortArray(@NotNull Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] m3910constructorimpl = UShortArray.m3910constructorimpl(collection.size());
        int i2 = 0;
        for (UShort uShort : collection) {
            UShortArray.m3921set01HTLdE(m3910constructorimpl, i2, uShort.m3908unboximpl());
            i2++;
        }
        return m3910constructorimpl;
    }
}
