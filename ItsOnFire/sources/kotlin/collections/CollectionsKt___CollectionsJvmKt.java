...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    ...
    public static final /* synthetic */ Float m4006max(Iterable iterable) {
        Float m4014maxOrNull;
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        m4014maxOrNull = CollectionsKt___CollectionsKt.m4014maxOrNull((Iterable<Float>) iterable);
        return m4014maxOrNull;
    }
    ...
    public static final /* synthetic */ Float m4008min(Iterable iterable) {
        Float m4022minOrNull;
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        m4022minOrNull = CollectionsKt___CollectionsKt.m4022minOrNull((Iterable<Float>) iterable);
        return m4022minOrNull;
    }
