...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j2, long j3, long j4) {
        ...
        this.hasNext = z;
        this.step = ULong.m3753constructorimpl(j4);
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m3747boximpl(m4833nextsVKNKU());
    }

    /* renamed from: next-s-VKNKU  reason: not valid java name */
    public long m4833nextsVKNKU() {
        long j2 = this.next;
        if (j2 != this.finalElement) {
            this.next = ULong.m3753constructorimpl(this.step + j2);
