...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i2, int i3, int i4) {
        ...
        this.hasNext = z;
        this.step = UInt.m3675constructorimpl(i4);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m3669boximpl(m4826nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA  reason: not valid java name */
    public int m4826nextpVg5ArA() {
        int i2 = this.next;
        if (i2 != this.finalElement) {
            this.next = UInt.m3675constructorimpl(this.step + i2);
