...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m4832fromClosedRange7ftBX0g(long j2, long j3, long j4) {
    ...
    private ULongProgression(long j2, long j3, long j4) {
        ...
        this.first = j2;
        this.last = UProgressionUtilKt.m4808getProgressionLastElement7ftBX0g(j2, j3, j4);
        this.step = j4;
    }
    ...
    public final long m4830getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m4831getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j3 = this.last;
        long j4 = this.step;
        return ((int) ((j4 >>> 32) ^ j4)) + (((((int) ULong.m3753constructorimpl(j2 ^ ULong.m3753constructorimpl(j2 >>> 32))) * 31) + ((int) ULong.m3753constructorimpl(j3 ^ ULong.m3753constructorimpl(j3 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m3798toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m3798toStringimpl(this.last));
            sb.append(" step ");
            j2 = this.step;
        } else {
            sb = new StringBuilder();
