...
final class RunSuspend implements Continuation<Unit> {
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m3590unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m4805getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(@NotNull Object obj) {
        synchronized (this) {
            this.result = Result.m3580boximpl(obj);
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type java.lang.Object");
            notifyAll();
